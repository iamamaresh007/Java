...
class Main {
    public static void main(String[] args) {
        List<Employee> employees = List.of(
            ...
            Map<String, Optional<Employee>> result = employees.stream().collect(Collectors.groupingBy(Employee::getDept, Collectors.maxBy(Comparator.comparing(Employee::getAge))));
            
            System.out.println("Oldest Employee is each dept are" + result);
            
            result.forEach((k, v) ->
            System.out.println("Department is " + k + " and employee is " + v.orElse(null)));
    }
}
