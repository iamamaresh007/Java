...
class Main {
    public static void main(String[] args) {
        List<Employee> employees = List.of(
            ...
            Employee youngestEmployee = employees.stream().sorted(Comparator.comparing(Employee::getAge)).findFirst().orElse(null);
            
            Employee oldestEmployee = employees.stream().max(Comparator.comparing(Employee::getAge)).orElse(null);
            
            System.out.println("Youngest employee is " + youngestEmployee);
            System.out.println("Oldest employee is " + oldestEmployee);
    }
}
