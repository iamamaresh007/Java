...
class Main {
    public static void main(String[] args) {
        List<Employee> employees = List.of(
            ...
            Double salary = employees.stream().mapToDouble(Employee::getSalary).distinct().boxed().sorted(Comparator.reverseOrder()).skip(1).findFirst().orElse(null);
            
            System.out.println("Second Highest salary employee is ---> " + secondHighestSalary);
