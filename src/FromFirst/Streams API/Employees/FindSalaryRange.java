...
class Main {
    public static void main(String[] args) {
        List<Employee> employees = List.of(
            ...
            List<Employee> emps = employees.stream().filter(e -> e.getSalary() >= 50000 && e.getSalary() <= 80000).collect(Collectors.toList());
            
            System.out.println("Employess having salary between 50k to 80k are" + emps);
    }
}
