...
class Main {
    public static void main(String[] args) {
        List<Employee> employees = List.of(
            ...
            Employee emp = employees.stream().sorted(Comparator.comparing(Employee::getSalary).reversed()).skip(2).findFirst().orElse(null);
            
            System.out.println("Third highest salary is " + emp);
    }
}
