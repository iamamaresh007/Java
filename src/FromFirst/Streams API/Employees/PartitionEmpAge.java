...
class Main {
    public static void main(String[] args) {
        List<Employee> employees = List.of(
            ...
            Map<Boolean, List<Employee>> agePartition = employees.stream().collect(Collectors.partitioningBy(e -> e.getAge() > 30));
            
            System.out.println("After age > 30 partition " + agePartition);
            System.out.println("------------------------------------------------------------------------------------");
            
            agePartition.forEach((k, v) -> {
                if(k) System.out.println("Employee age > 30 are " + v);
                 else System.out.println("Employee age < 30 are " + v);
            }
        );
    }
}
